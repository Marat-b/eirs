...
namespace QuickApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            /*if (!_env.IsDevelopment() && !string.IsNullOrWhiteSpace(Configuration["HttpsRedirectionPort"])) //commented by me
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (env.IsDevelopment()) // commented by me
            {
            ...
            //app.UseHttpsRedirection(); //commented by me
            app.UseStaticFiles();
            ...
            app.UseSpa(spa =>
            {
                ...
                if (env.IsDevelopment())
                {
                    ...
                    spa.Options.StartupTimeout = TimeSpan.FromSeconds(480); // Increase the timeout if angular app is taking longer to startup
                    //spa.UseProxyToSpaDevelopmentServer("http://localhost:4200"); // Use this instead to use the angular cli server
                    #if DEBUG
                    Debug.WriteLine(" **************************  It is Development mode *************************");
                    #endif
                }
            });
        }
