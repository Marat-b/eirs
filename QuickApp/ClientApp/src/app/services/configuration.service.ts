...
export class ConfigurationService {
  ...
  set showDevices(value: boolean) {
    this._showDevices = value;
    this.saveToLocalStore(value, DBkeys.SHOW_DEVICE);
  }
  get showDevices() {
    return this._showDevices != null ? this._showDevices : ConfigurationService.defaultShowDevices;
  }
  ...
  public static readonly defaultShowDevices: boolean = true;
  ...
  public fallbackBaseUrl = 'http://127.0.0.1/eirs';
  // ***End of defaults***
  ...
  private _showDevices: boolean = null;
  ...
  private loadLocalChanges() {
    ...
    if (this.localStorage.exists(DBkeys.SHOW_DEVICE)) {
      this._showDevices = this.localStorage.getDataObject<boolean>(DBkeys.SHOW_DEVICE);
    }
  ...
  public import(jsonValue: string) {
    ...
    if (jsonValue) {
      ...
      if (importValue.showDevices != null) {
        this.showDashboardStatistics = importValue.showDevices;
      }
  ...
  public export(changesOnly = true): string {
    const exportValue: UserConfiguration = {
      ...
      showDevices: changesOnly ? this._showDevices : this.showDevices
  ...
  public clearLocalChanges() {
    ...
    this.localStorage.deleteData(DBkeys.SHOW_DEVICE);
