...
export class AuthService {
  ...
  private configureOauthService(rememberMe?: boolean) {
    ...
    this.oauthService.requireHttps = false; // added by me
    this.oauthService.strictDiscoveryDocumentValidation = false; // added by me
    // this.oauthService.oidc = false; // added by me
    this.oauthService.skipIssuerCheck = true; // added by me
    // this.oauthService.showDebugInformation = true; // added by me
