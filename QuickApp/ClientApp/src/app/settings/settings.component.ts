...
export class SettingsComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  @ViewChild('timeintervals', { static: true }) timeintervalsPanel: MatExpansionPanel;
  ...
  @ViewChild(TimeIntervalComponent, {static: true}) timeInterval: TimeIntervalComponent;
